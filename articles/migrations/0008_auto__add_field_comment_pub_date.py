...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'articles_comment', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(default='NULL'), keep_default=False)
    ...
    models = {
        ...
        u'articles.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': "'NULL'"}),
